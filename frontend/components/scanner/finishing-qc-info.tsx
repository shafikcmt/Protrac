...
type FinishingQCInfoResponse = z.infer<typeof schemas.FinishingQCInfoResponse>;

interface FinishingQCInfoProps {
  data?: FinishingQCInfoResponse;
  isLoading: boolean;
}

export function FinishingQCInfo({ data, isLoading }: FinishingQCInfoProps) {
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-1 flex-1">
                        ...
                        <p className="text-sm font-medium">
                          From {qc.sewing_line} → {qc.finishing_line}
                        </p>
